...
TEST(and_c_test, true)
{
    ...
    STATIC_ASSERT_TRUE_VALUE(and1);
    using and2 = mpl::and_c<true, true>;
    STATIC_ASSERT_TRUE_VALUE(and2);
    using and3 = mpl::and_c<true, true, true>;
    STATIC_ASSERT_TRUE_VALUE(and3);
    using and4 = mpl::and_c<true, true, true, true>;
    STATIC_ASSERT_TRUE_VALUE(and4);
}
