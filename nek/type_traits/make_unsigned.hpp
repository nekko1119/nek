...
namespace nek
{
    namespace detail
    {
        ...
        {
            typedef typename make_unsigned_from_integral<typename remove_cv<T>::type>::type type;
        };

        template <class T>
        struct make_unsigned_impl<T, false, true>
        {
            typedef typename make_unsigned_from_enum<typename remove_cv<T>::type>::type type;
        };
